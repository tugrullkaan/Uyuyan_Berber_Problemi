...
#define koltukSayisi 2		// Berber 2 tane ve berber koltuğumuzda 2 tane
...
void Musteri(void* sayi)	// Müşteri fonksiyonu müşteri numarasını parametre olarak alır  //burak
{
...
int main(int argc , char** args) //osman
{	
